        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#publication" class="py-2 d-block">Publications</a></li>
                <li><a href="#v-pills-effect" class="py-2 d-block">Events</a></li>
                <li><a href="#" class="py-2 d-block">News</a></li>
                <li><a href="#" class="py-2 d-block">Feeds</a></li>
                <li><a href="#history" class="py-2 d-block">History</a></li>
              </ul>
            </div>
          </div>
